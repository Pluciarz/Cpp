// Liczby Smitha.cpp : Ten plik zawiera funkcję „main”. W nim rozpoczyna się i kończy wykonywanie programu.
//
...
{
    int i = n;
    if (suma_cyfr(i) == suma_czynnikow(n) && czy_pierwsza(n) == false)
    {
        return true;
    }
    return false;
